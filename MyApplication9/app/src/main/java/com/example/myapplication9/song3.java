...
public class song3 extends AppCompatActivity{
    ...
    private MusicPlayer3.MusicControl control;//声明MusicService中的音乐控制器

    private ServiceConnection connection = new ServiceConnection() { //声明服务连接
        @Override
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            control = (MusicPlayer3.MusicControl) iBinder;//实例化音乐控制对象，即control。
        }
        @Override
    ...
    public void init(){
        iv_cover = findViewById(R.id.iv_cover3);
        sb = findViewById(R.id.sb3);
        tv_progress = findViewById(R.id.tv_progress3);
        tv_total = findViewById(R.id.tv_total3);

        btn_play = findViewById(R.id.btn_play3);
        btn_pause = findViewById(R.id.btn_pause3);
        btn_continue = findViewById(R.id.btn_continue3);
        btn_exit = findViewById(R.id.btn_exit3);
        ...
        Intent mintent = new Intent(song3.this,MusicPlayer3.class);

...
public class song2 extends AppCompatActivity{
    ...
    private MusicPlayer2.MusicControl control;//声明MusicService中的音乐控制器

    private ServiceConnection connection = new ServiceConnection() { //声明服务连接
        @Override
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            control = (MusicPlayer2.MusicControl) iBinder;//实例化音乐控制对象，即control。
        }
        @Override
    ...
    public void init(){
        iv_cover = findViewById(R.id.iv_cover2);
        sb = findViewById(R.id.sb2);
        tv_progress = findViewById(R.id.tv_progress2);
        tv_total = findViewById(R.id.tv_total2);

        btn_play = findViewById(R.id.btn_play2);
        btn_pause = findViewById(R.id.btn_pause2);
        ...
        Intent mintent = new Intent(song2.this,MusicPlayer2.class);

...
public class song1 extends AppCompatActivity{
    ...
    private MusicPlayer1.MusicControl control;//声明MusicService中的音乐控制器

    private ServiceConnection connection = new ServiceConnection() { //声明服务连接
        @Override
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            control = (MusicPlayer1.MusicControl) iBinder;//实例化音乐控制对象，即control。
        }
        @Override
    ...
    public void init(){
        iv_cover = findViewById(R.id.iv_cover1);
        sb = findViewById(R.id.sb1);
        tv_progress = findViewById(R.id.tv_progress1);
        tv_total = findViewById(R.id.tv_total1);

        btn_play = findViewById(R.id.btn_play1);
        btn_pause = findViewById(R.id.btn_pause1);
        btn_continue = findViewById(R.id.btn_continue1);
        btn_exit = findViewById(R.id.btn_exit1);
        ...
        Intent mintent = new Intent(song1.this,MusicPlayer1.class);
